...
<head>
    ...
    <div class="row" >
        <div class="col-md-10"> 
        <div class="card">
            <div class="card-header"> Add Feedback
           </div>
            <div class="card-body">
                   <form action="{{url('feedback/add')}}" method="post" name="addfeedback" id"addFeedback">
                    ...
                    <textarea name="feedback" id="feedback" col="30" rows="5" class="form-control">  </textarea>
                          @if($errors->any())
                    ...
                    <input type="text" name="name" id="name" class="form-control">  </textarea>
                         @if($errors->any())
